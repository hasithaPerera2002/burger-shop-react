                    ...
                    <div className="flex flex-wrap h-full">
                        {
                            ...
                            burgerList.map((burger:Burger, index:number) => (
                                ...
                                <div
                               key={index} className="w-full rounded-3xl overflow-hidden sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 p-4">
                                <MenuCard image={burger.image} name={burger.name} key={index} price={100}/>
